...
public final class ValidationContracts {
  ...
  public record ValidationRunListItem(UUID id, ValidationStatus status, String cliVersion, String kitVersion, String modelPin, String actorSubject, Instant completedAt, int findingCount) {}
