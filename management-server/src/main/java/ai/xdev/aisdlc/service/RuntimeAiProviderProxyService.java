...
public class RuntimeAiProviderProxyService {
  ...
  private final JdbcTemplate jdbc; private final RuntimeAiBrokerService broker; private final ProjectAccessService access; private final AuditService audit; private final ProviderCredentialResolver credentials; private final ProviderHttpTransport transport;
  public RuntimeAiProviderProxyService(JdbcTemplate jdbc, RuntimeAiBrokerService broker, ProjectAccessService access, AuditService audit, ProviderCredentialResolver credentials, ProviderHttpTransport transport) { this.jdbc=jdbc; this.broker=broker; this.access=access; this.audit=audit; this.credentials=credentials; this.transport=transport; }
