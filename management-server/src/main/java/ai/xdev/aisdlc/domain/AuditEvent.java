...
public class AuditEvent {
  ...
  public AuditEvent(UUID tenantId, UUID organizationId, UUID projectId, String actorSubject, String action, String entityType, String entityId, String payload, long sequence, String previousHash, String eventHash) { this.tenantId = tenantId; this.organizationId = organizationId; this.projectId = projectId; this.actorSubject = actorSubject; this.action = action; this.entityType = entityType; this.entityId = entityId; this.payload = payload; this.sequence = sequence; this.previousHash = previousHash; this.eventHash = eventHash; }
