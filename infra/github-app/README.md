...
The manifest requests only read access to repository delivery context and write access to Checks. It subscribes only to the events handled by the control plane. See [`docs/scm-integration.md#github-scm-integration`](../../docs/scm-integration.md#github-scm-integration) for the verification, secret rotation, and incident-response procedures.
