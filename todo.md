...
- [ ] Post-P2 P3: extend SCM/work-management integrations to GitLab, Bitbucket, Azure DevOps, and Jira using the existing versioned connector contract. (Inbound ingress, verification, correlation, and idempotency are implemented for all four; outbound policy feedback per connector is still outstanding. See docs/scm-connector-contract.md.)
