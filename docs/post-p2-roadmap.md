...
The implementation-ready design for **P3.1 Reliability** and **P3.3 Runtime AI Governance** is maintained in [`runtime-ai-governance.md`](runtime-ai-governance.md). The associated [P3.1 resilience/chaos plan](observability-and-resilience.md#p31-reliability-resilience-and-chaos-engineering-test-plan) defines isolated fault-injection test cases, game-day safety controls, and evidence requirements. [`cost-governance.md`](cost-governance.md) defines the provider-neutral P3.2 ledger, price catalog, forecast, budget, and approval architecture.
