...
The inference usage ledger, the deterministic forecast built on it, and budget policies that can warn or hold but never route a model.

- [P3.2 Cost Optimization and Inference Forecasting Design](#p32-cost-optimization-and-inference-forecasting-design)
- [P3 Budget Enforcement and Runtime Broker Foundation](#p3-budget-enforcement-and-runtime-broker-foundation)
